...
<header>
    ...
    <div class = "Mcontainer">
        <!--Navigation Bar-->
        <!-- <div class = "Bar">
            <img id = "Logo" src = "image/default_logo_w.png" alt = "Society Logo">
            <div class = "Name">
                Society<br>Connect
            </div>
            <ul>
            <li><a href="mainpage.php">HOME</a></li>
            <li><a href="jobfinder.php" >JOB FINDER</a></li>
            <li><a href="skillsync.php">SKILL SYNC</a></li>
            <li><a href="event.php">EVENT</a></li>
            </ul>
            <img id = "Setting" src = "image/setting.jpg" alt = "Setting">
            <img id = "Profile" src = "image/users_profile.jpg" alt = "Profile">
        </div> -->
              ...
              <Div class="bannerbackgound">
                  ...
                  <div class="bannerimg">
                      <div class="bannerimg1">
                          <img id = "Job1" src = "image/job1.png" alt = "Job1">
                          <img id = "Job3" src = "image/job3.png" alt = "Job3">
                      </div>
                      <div class="bannerimg2">
                          <img id = "Job2" src = "image/job2.png" alt = "Job2">
                          <img id = "Job4" src = "image/job4.png" alt = "Job4">
                      </div>
                  </div>
              </Div>
          </div>
